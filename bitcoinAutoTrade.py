...
access = "5psXTqTvYF9rue6KmFXYr1F7Mvx29KnxXfoftlDo"
secret = "l7dIexqcxpBMJevcxvn0dU6eDZDAUItHbhjI0eCm"
...
while True:
    try:
        ...
        start_time = get_start_time("KRW-MANA") - datetime.timedelta(seconds=10)
